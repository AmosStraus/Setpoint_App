...
String workingTime(TimeOfDay startTime, TimeOfDay finishTime) {
  return ((toDouble(finishTime) - toDouble(startTime)).toStringAsFixed(2));
}
...
String parseRawDateToHebrew(DateTime rawDate) =>
    parseDateToHebrew(rawDateToDateString(rawDate));
